    ...
    <main className="relative min-h-screen w-full bg-[#0a0a0a] overflow-x-hidden text-white">
      ...
      <div className="relative z-10 w-full max-w-[1100px] mx-auto pt-[140px] pb-24 px-4 sm:px-6 md:px-8">
        ...
        >
          ...
          <button
            className="flex items-center gap-2 h-11 px-8 rounded-xl font-caviar text-sm font-semibold transition-all duration-200 shrink-0"
        ...
        {/* Share & Other Announcements Row */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
          {/* Share */}
          <div className="rounded-2xl p-6 flex items-center gap-5" style={{ background: "rgba(201,155,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
            <span className="font-caviar text-xs text-white/30 uppercase tracking-wider shrink-0">Paylaş</span>
            <div className="flex items-center gap-2">
              <button className="w-9 h-9 rounded-full flex items-center justify-center text-white/30 hover:text-[#C99BFF] transition-colors duration-200" style={{ background: "rgba(201,155,255,0.06)", border: "1px solid rgba(201,155,255,0.12)" }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </button>
              <button className="w-9 h-9 rounded-full flex items-center justify-center text-white/30 hover:text-[#C99BFF] transition-colors duration-200" style={{ background: "rgba(201,155,255,0.06)", border: "1px solid rgba(201,155,255,0.12)" }}>
                <svg width="16" height="12" viewBox="0 0 24 18" fill="currentColor"><path d="M20.317 1.492a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 1.492.07.07 0 0 0 3.644 1.52C.533 6.093-.319 10.555.099 14.961a.082.082 0 0 0 .031.056 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.009c.12.098.246.198.373.293a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.029 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.055c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.02z" /></svg>
              </button>
              <button className="w-9 h-9 rounded-full flex items-center justify-center text-white/30 hover:text-[#C99BFF] transition-colors duration-200" style={{ background: "rgba(201,155,255,0.06)", border: "1px solid rgba(201,155,255,0.12)" }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></svg>
              </button>
            </div>
          </div>
